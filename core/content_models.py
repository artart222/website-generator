...
DEFAULT_MODELS: dict[str, dict[str, Any]] = {
    ...
    # Core stays intentionally generic. Commerce-specific product fields (sku,
    # price, variants, tax_class, ...) are owned by the wg-commerce extension,
    # which merges them into this model when enabled.
    "product": {
        "fields": {
            "title": {"type": "string", "required": True},
            "slug": {"type": "string"},
